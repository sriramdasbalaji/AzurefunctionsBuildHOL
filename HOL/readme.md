...
1. Now you will see that all the required tasks are automatically added to the build definition by the template. These are the steps that will automatically run every time within the build definition when you commit the code.
